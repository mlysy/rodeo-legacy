...
def kalman_ode_higher(fun, x0_state, tmin, tmax, n_eval, wgt_state, mu_state, var_state, wgt_meas):
    """
    ...
    for t in range(n_eval):
        ...
        x_state_tt = mu_state_preds[t+1] + R_tt.dot(I_tt) 
    ...
    x_states[-1] = np.random.multivariate_normal(mu_state_smooths[-1], var_state_smooths[-1], tol=1e-6)
